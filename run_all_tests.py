...
Uso:
    ~/envs/sentimiento/bin/python run_all_tests.py
"""
import subprocess
import sys
import os
...
TESTS = [
    ...
    ("BERT",           "tests/BERT",           "test_bert.py"),
    ("FinBERT",        "tests/FinBERT",         "test_finbert.py"),
    ("DistilRoBERTa",  "tests/DistilRoBERTa",   "test_distilroberta.py"),
    ("DeBERTa v3",     "tests/DeBERTa v3",      "test_deberta.py"),
    ("FinancialBERT",  "tests/FinancialBERT",   "test_financialbert.py"),
    ("llama3.1",       "tests/llama3.1",        "test_llama3.1.py"),
    ("llama3.2",       "tests/llama3.2",        "test_llama3.2.py"),
    ("phi3.5",         "tests/phi3.5",          "test_phi3.5.py"),
    ("phi3.5-mlx (vs ollama)", "tests/phi3.5-mlx", "test_mlx_vs_ollama.py"),
    ("phi3.5-mlx (nvidia)",    "tests/phi3.5-mlx", "test_mlx_nvidia.py"),
]
