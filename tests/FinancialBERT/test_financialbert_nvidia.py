"""
Test NVIDIA: ahmedrachid/FinancialBERT-Sentiment-Analysis — zero-shot sobre nvidia_testing.csv
...
csv_out = f"{RESULTS_DIR}/financialbert_nvidia_predictions.csv"
...
json_out = f"{RESULTS_DIR}/financialbert_nvidia_metadata.json"
meta = {
