"""
Test individual: yiyanghkust/finbert-tone
...
def export_results(model_name, headlines, true_labels, pred_labels, metrics,
    ...
    meta = {
        ...
        "approach": "fine-tuning (3 epochs, lr=2e-5) — pre-trained on financial text",
        "performance": {
...
args = TrainingArguments(
    output_dir=f"{RESULTS_DIR}/checkpoints_finbert",
...
export_results(MODEL_NAME, headlines, true_labels, pred_labels,
               metrics, train_time, inf_times, mem_mb, RESULTS_DIR, "finbert")
