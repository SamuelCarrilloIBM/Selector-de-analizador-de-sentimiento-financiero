"""
Test NVIDIA: llama3.1:8b via Ollama — few-shot sobre nvidia_testing.csv
...
RESULTS_DIR = "../../results/ollama/llama3.1"
...
# Few-shot: primeros 3 ejemplos del CSV como contexto, resto como test
FEW_SHOT = samples[:3]
test_pool = samples[3:]
